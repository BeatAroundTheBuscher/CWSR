...
public class MyRemnantThemeGenerator extends BaseThemeGenerator {
...
//			}
		...
		MySalvageSpecialAssigner.SpecialCreationContext specialContext = new MySalvageSpecialAssigner.SpecialCreationContext();
		specialContext.themeId = getThemeId();
		MySalvageSpecialAssigner.assignSpecials(remnantSystems, specialContext);
...
//			}
	...
	public void populateNonMain(StarSystemData data) {
		...
		addShipGraveyard(data, 0.05f, 1, 1,
				createStringPicker(Factions.PERSEAN, 10f, Factions.HEGEMONY, 7f, Factions.INDEPENDENT, 3f));
