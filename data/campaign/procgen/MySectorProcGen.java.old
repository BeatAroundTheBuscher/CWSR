...
import data.campaign.procgen.themes.MySectorThemeGenerator;
...
public class MySectorProcGen implements SectorProcGenPlugin {
...
//				}
		...
		MySectorThemeGenerator.generate(context);
